...
svc_jumps       DEFW    LCD_write                 ; SVC 0 = LCD_write
                ...
                DEFW    Get_PIOB                  ; SVC 2 = get piob
                DEFW    Buzzer_set                ; SVC 3 = set buzzer on/off
...
isr_done        LDMFD   SP!, {R0-R2, LR}          ; restore & return
                SUBS    PC, LR, #4
