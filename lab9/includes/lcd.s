...
; Procedure to write & pad so that the next thing we write is on the second line
; R0 = start address of string

LCD_Write_pad   STMFD SP!, {LR, R0, R1}
;                MOV   R2, R0                ; move R0 > R2
;                MOV   R1, #0                ; set counter to 0
;next_byte       CMP   R1, #40               ; are we at end of line yet
;                BEQ   wstr_dne
;LDRB  R0, [R2, R1]          ; load our byte into R2 and increment
